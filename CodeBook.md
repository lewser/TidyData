...
#####Variable 09          
    Time_GravityAcc_Mean_X            
      Description: Time_GravityAcc_Mean_X is an integer used to represent the *average* mean value of the time signal  
      representing the gravitational acceleration signal for the X direction.  
...
#####Variable 10          
    Time_GravityAcc_Mean_Y            
      Description: Time_GravityAcc_Mean_Y is an integer used to represent the *average* mean value of the time signal  
      representing the gravitational acceleration signal for the Y direction.  
...
#####Variable 11          
    Time_GravityAcc_Mean_Z            
      Description: Time_GravityAcc_Mean_Z is an integer used to represent the *average* mean value of the time signal  
      representing the gravitational acceleration signal for the Z direction.  
