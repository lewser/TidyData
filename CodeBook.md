...
#####Variable 33          
    Time_BodyAccMag_Mean_X            
      Description: Time_BodyAccMag_Mean_X is an integer used to represent the *average* mean value of the  
      time signal representing the body acceleration magnitude signal for the X direction.  
      
      Data Prep Note: represents an aggregate average value based on dozens of observations. The individual  
      observations are still located in the fp_x_combination data set generated by the run_analysis.R script.  
      
#####Variable 34          
    Time_BodyAccMag_STD_X            
      Description: Time_BodyAccMag_STD_X is an integer used to represent the *average* statistical  
      deviation of the time signal representing the body acceleration magnitude signal for the X direction.  
      
      Data Prep Note: represents an aggregate average value based on dozens of observations. The individual  
      observations are still located in the fp_x_combination data set generated by the run_analysis.R script.  
      
#####Variable 35          
    Time_GravityAccMag_Mean_X            
      Description: Time_GravityAccMag_Mean_X is an integer used to represent the *average* mean value of the  
      time signal representing the gravitational acceleration magnitude signal for the X direction.  
      
      Data Prep Note: represents an aggregate average value based on dozens of observations. The individual  
      observations are still located in the fp_x_combination data set generated by the run_analysis.R script.  
      
#####Variable 36          
    Time_GravityAccMag_STD_X            
      Description: Time_GravityAccMag_STD_X is an integer used to represent the *average* statistical  
