...
#####Variable 68          
    Frequency_BodyBodyGyroJerkMag_STD            
      Description: Frequency_BodyBodyGyroJerkMag_STD is an integer used to represent the *average* statistical  
      deviation of the frequency signal representing the body-body gyroscope jerk magnitude signal.  
